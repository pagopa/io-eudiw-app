...
`itWalletFeature` satisfies `MiniApp<'it-wallet', 'wallet', MainNavigatorParamsList>` and is the only export consumed by the host app. See the `main-app` [README](../../apps/main-app/README.md) for integration instructions.
