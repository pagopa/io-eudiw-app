...
const credentialIssuanceStatusSlice = createSlice({
  name: 'credentialIssuanceStatus133',
  initialState,
  reducers: {
...
) => state.wallet133.credentialIssuanceStatus.statusPreAuth;

export const selectCredentialIssuancePostAuthStatus = (
  state: WalletCombinedRootState
) => state.wallet133.credentialIssuanceStatus.statusPostAuth;

export const selectRequestedCredential = (state: WalletCombinedRootState) =>
  state.wallet133.credentialIssuanceStatus.requestedCredential;

export const selectRequestedCredentialType = (state: WalletCombinedRootState) =>
  state.wallet133.credentialIssuanceStatus.requestedCredentialType;

export const selectCredentialIssuancePostAuthError = (
  state: WalletCombinedRootState
) => state.wallet133.credentialIssuanceStatus.statusPostAuth.error.error;

export const selectCredentialIssuancePreAuthError = (
  state: WalletCombinedRootState
) => state.wallet133.credentialIssuanceStatus.statusPreAuth.error.error;
