...
export const selectPreDefinitionStatus = (state: WalletCombinedRootState) =>
  state.wallet133.presentation.preDefinition;
...
export const selectPreDefitionResult = (state: WalletCombinedRootState) =>
  state.wallet133.presentation.preDefinition.success.status === true
    ? state.wallet133.presentation.preDefinition.success.data
    : undefined;
...
export const selectPostDefinitionStatus = (state: WalletCombinedRootState) =>
  state.wallet133.presentation.postDefinition;
...
export const selectPostDefinitionResult = (state: WalletCombinedRootState) =>
  state.wallet133.presentation.postDefinition.success.status === true
    ? state.wallet133.presentation.postDefinition.success.data
    : undefined;
...
export const selectOptionalCredentials = (state: WalletCombinedRootState) =>
  state.wallet133.presentation.optionalCredentials;
...
export const selectCredentialNotFound = (state: WalletCombinedRootState) =>
  state.wallet133.presentation.credentialNotFound;
