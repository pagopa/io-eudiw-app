...
export class ValidationFailed extends IoWalletError {
  override code = 'ERR_IO_WALLET_VALIDATION_FAILED';
...
export class UnexpectedStatusCodeError extends IoWalletError {
  override code = 'ERR_UNEXPECTED_STATUS_CODE';
  statusCode: number;
...
export class IssuerResponseError extends UnexpectedStatusCodeError {
  override code: IssuerResponseErrorCode;
...
export class WalletProviderResponseError extends UnexpectedStatusCodeError {
  override code: WalletProviderResponseErrorCode;
  override reason: ProblemJson;
...
export class RelyingPartyResponseError extends UnexpectedStatusCodeError {
  override code: RelyingPartyResponseErrorCode;
...
export class UnimplementedFeatureError extends IoWalletError {
  override code = 'ERR_IO_WALLET_UNIMPLEMENTED_FEATURE';
