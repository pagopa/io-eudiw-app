...
interface Props {
  ...
  disabled?: boolean;
  buttonType: React.ComponentProps<typeof KeyPad>["buttonType"];
...
class Pinpad extends React.PureComponent<Props, State> {
   ...
   */
  private pinPadDigits = (): React.ComponentProps<typeof KeyPad>["digits"] => {
    ...
    return (
      <React.Fragment>
        ...
        {this.props.onCancel && (
          <React.Fragment>
            <VSpacer size={24} />
            <LabelLink style={styles.mediumText} onPress={this.props.onCancel}>
