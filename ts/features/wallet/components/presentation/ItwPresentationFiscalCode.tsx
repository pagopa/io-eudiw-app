...
import { selectFiscalCodeFromEid } from '../../store/selectors/wallet';
...
const ItwPresentationFiscalCode = () => {
  ...
  const fiscalCode = useAppSelector(selectFiscalCodeFromEid);

  const handleOnPress = () => {
    navigation.navigate(MAIN_ROUTES.WALLET_NAV, {
      screen: WALLET_ROUTES.PRESENTATION.CREDENTIAL_FISCAL_CODE_MODAL
    });
  };
  ...
  return (
    <Pressable
      ...
      accessibilityHint={I18n.t(
        'presentation.credentialDetails.fiscalCode.action',
        {
          ns: 'wallet'
        }
      )}
      accessibilityLabel={I18n.t(
        'presentation.credentialDetails.fiscalCode.label',
        {
          ns: 'wallet'
        }
      )}
