...
import { NewCredential } from '../../utils/itwCredentialUtils';
...
const i18nNs =
  'presentation.credentialDetails.newCredentialValidityAlert.content';
...
export const ItwPresentationNewCredentialValidityAlert = ({
  ...
  const content = I18n.t(`${i18nNs}.${credentialType}`, { ns: 'wallet' });
