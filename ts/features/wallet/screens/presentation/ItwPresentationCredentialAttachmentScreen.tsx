...
import { ItwGenericErrorContent } from '../../components/ItwGenericErrorContent';
import { pdfSchema } from '../../utils/claims';
...
type ScreenProps = StackScreenProps<
  ...
  'PRESENTATION_CREDENTIAL_ATTACHMENT'
>;
...
const getAttachmentData = ({
  ...
  const parsed = pdfSchema.safeParse({ name, value });

  if (parsed.success) {
    return {
      fileName,
      uri: parsed.data.value,
